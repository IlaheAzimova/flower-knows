...
function LongTermOffer() {
    ...
    const currentGift = GIFT_TABS[activeGiftTab];
                        ...
                        <div>
                            ...
                            >
                                {mustHaveSets.map((product) => (
                                    <div
                                        key={product.id}
                                        className="min-w-[70%] sm:min-w-[45%] md:min-w-0 snap-center p-2 md:p-0"
                                    >
                                        <ProductCard product={product} bg="bg-[#faf9f8]" />
                                    </div>
                                ))}
                            </div>
