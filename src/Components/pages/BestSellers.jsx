...
function BestSellers() {
    ...
    const baseCollectionProducts = useMemo(() => {
        ...
        return products.filter((p) => {
            ...
            return colStr.includes('bestseller');
        });
    }, [products]);
    ...
    const displayedProducts = showAll ? bestSellerProducts : bestSellerProducts.slice(0, initialCount);
            ...
            <div className="md:w-[90%] mx-auto px-4 md:px-8 pb-16">
                ...
                <div className="flex flex-wrap gap-2 mb-10">
                    {CATEGORIES.map((cat) => (
                        <button
                            ...
                            className={`px-3.5 py-1.5 text-[11px] tracking-[1.5px] uppercase border transition cursor-pointer ${selectedCategory === cat
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {/* SHOW MORE DÜYMƏSİ */}
                        {!showAll && bestSellerProducts.length > initialCount && (
                            <div className="flex justify-center mt-14">
                                ...
                                >
                                    Show More ({bestSellerProducts.length - initialCount} more)
                                </button>
                            </div>
                        )}
                    </>
