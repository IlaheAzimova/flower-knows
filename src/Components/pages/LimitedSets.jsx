...
function ProductCard({ product }) {
    ...
    // Setlərin üzərindəki VALUE dəyəri və ya NEW etiketi
    const valueTag = product.value || (originalPrice ? `VALUE ${formatPrice(Math.round(originalPrice))}` : null);
    const isNew = (Array.isArray(product.tags) && product.tags.some(t => t.toLowerCase() === 'new')) || product.isNew;
        ...
        <div className="group flex flex-col">
            <div className="relative overflow-hidden bg-[#faf9f8] aspect-[4/5]">
                <Link to={`/products/${toSlug(product.title)}`}>
                    ...
                    {/* Sağ yuxarı etiketlər: VALUE və NEW */}
...
function LimitedSets() {
    ...
    const baseCollectionProducts = useMemo(() => {
        ...
        return products.filter((p) => {
            ...
            // 2. Setting powder kimi tək məhsulları mütləq kənarlaşdırırıq
    ...
    const limitedProducts = useMemo(() => {
        ...
        // A. Açılan Filter menyusundakı Product Type-lar
        ...
        return sortedList;
    }, [baseCollectionProducts, selectedTypes, minPrice, maxPrice, sortBy]);
        ...
        <div className="w-full bg-white min-h-screen">
            ...
            <div className="pt-12 pb-8 text-center px-4">
                ...
                <div className="dmsans text-[13px] md:text-[14px] text-[#555] space-y-1">
                    <p>Spend {formatPrice(50)}+, get a Get a Mini Rosy Bow Pouch</p>
